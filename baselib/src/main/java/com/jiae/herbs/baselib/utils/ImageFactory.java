...
//        return compress(bitmap, maxSize); // 这里再进行质量压缩的意义不大，反而耗资源，删除
     ...
     * @return
     */
    public static Bitmap ratio(Bitmap image, boolean isCircle, float pixelW, float pixelH) {
...
//      return compress(bitmap, maxSize); // 这里再进行质量压缩的意义不大，反而耗资源，删除
     ...
     *
     * @param image    数据源
     * @param isCircle 是否回收数据源
     * @param outPath  输出路径
     * @param pixelW   target pixel of width
     * @param pixelH   target pixel of height
     * @throws FileNotFoundException
     */
    public static void ratioAndGenThumb(Bitmap image, boolean isCircle, String outPath, float pixelW, float pixelH) throws FileNotFoundException {
        Bitmap bitmap = ratio(image, isCircle, pixelW, pixelH);
