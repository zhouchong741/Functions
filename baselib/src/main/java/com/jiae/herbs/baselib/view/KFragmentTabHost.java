 ...
 * 作者：kisen
 * 版本：
 * 创建时间：on 2017/5/15 13:39.
 */
public class KFragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    public KFragmentTabHost(Context context) {
    ...
    public KFragmentTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
