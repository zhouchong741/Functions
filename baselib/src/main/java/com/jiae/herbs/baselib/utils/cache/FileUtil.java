...
public class FileUtil {
    ...
    public static FileUtil getInstance() {
        if (instance == null) {
            synchronized (FileUtil.class) {
                if (instance == null) {
                    instance = new FileUtil(BaseApplication.getInstance());
                }
            }
        }
        return instance;
    ...
    private FileUtil(Context context) {
        String cache_dir = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "herbs" + File.separator;
