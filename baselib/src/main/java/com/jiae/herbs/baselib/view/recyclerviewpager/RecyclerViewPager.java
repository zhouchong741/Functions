package com.jiae.herbs.baselib.view.recyclerviewpager;
...
import com.jiae.herbs.baselib.BuildConfig;
...
public class RecyclerViewPager extends RecyclerView {
    ...
    private float mPagerMarginLeft;
    private float mPagerMarginTop;
    private float mPagerMarginRight;
    private float mPagerMarginBottom;
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyle) {
        ...
        mPagerMarginLeft = a.getDimension(R.styleable.RecyclerViewPager_pagerMarginLeft, 0);
        mPagerMarginTop = a.getDimension(R.styleable.RecyclerViewPager_pagerMarginTop, 0);
        mPagerMarginRight = a.getDimension(R.styleable.RecyclerViewPager_pagerMarginRight, 0);
        mPagerMarginBottom = a.getDimension(R.styleable.RecyclerViewPager_pagerMarginBottom, 0);
    ...
    public float getPagerMarginBottom() {
        return mPagerMarginBottom;
    }

    public void setPagerMarginBottom(float mPagerMarginBottom) {
        this.mPagerMarginBottom = mPagerMarginBottom;
    }

    public float getPagerMarginLeft() {
        return mPagerMarginLeft;
    }

    public void setPagerMarginLeft(float mPagerMarginLeft) {
        this.mPagerMarginLeft = mPagerMarginLeft;
    }

    public float getPagerMarginRight() {
        return mPagerMarginRight;
    }

    public void setPagerMarginRight(float mPagerMarginRight) {
        this.mPagerMarginRight = mPagerMarginRight;
    }

    public float getPagerMarginTop() {
        return mPagerMarginTop;
    }

    public void setmPagerMarginTop(float mPagerMarginTop) {
        this.mPagerMarginTop = mPagerMarginTop;
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        try {
            ...
            e.printStackTrace();
            LogUtil.d("dispatchTouchEvent", e.getMessage());
            return false;
        }
    }
